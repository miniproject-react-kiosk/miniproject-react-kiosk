            ...
            <div class='card-body'>
              ...
              <StCardText>
                <p class='card-text'>
                  ...
                  포테이토 브리오쉬 번, 스페셜 스모키 소스가 선사하는 <br></br>
                  놀랍도록 새로운 맛의 치킨 버거!
                </p>
              </StCardText>
            </div>
        ...
        <div class='col'>
          <div class='card h-100'>
            ...
            <div class='card-body'>
              ...
              <StCardText>
                <p class='card-text'>
                  매콤한 시즈닝을 입힌 100% 닭가슴 통살 위에 <br></br>아삭아삭한
                  양상추와 신선한 토마토~ 겉은 바삭, 속은 부드러운 <br></br>치킨
                  패티의 매콤함으로 입맛도 기분도 화끈하게!
                </p>
              </StCardText>
            </div>
          </div>
        ...
        <div class='col'>
          <div class='card h-100'>
            ...
            <div class='card-body'>
              ...
              <StCardText>
                <p class='card-text'>
                  든든한 맥치킨에 골든 모짜렐라 치즈 스틱 2개와 <br></br>매콤한
        ...
        <div class='col'>
          <div class='card h-100'>
            ...
            <div class='card-body'>
              ...
              <StCardText>
                <p class='card-text'>
                  두 장의 100% 순 쇠고기 패티와 그릴에 구운 1장의 베이컨을 얹고,{' '}
                  <br></br>신선한 토마토와 양상추, 매콤달콤한 스위트 칠리 소스,
                  치즈, 마요네즈를 더해 더욱 풍부하고 신선한 맛의 프리미엄 버거.
                </p>
              </StCardText>
            </div>
          </div>
